...
void OrderedDictionary::makeListOrder(OrderedDictionaryEntry *entry, ListNode *&head, ListNode *&last){
    if(entry == NULL)
...
void OrderedDictionary::makeListReverseOrder(OrderedDictionaryEntry *entry, ListNode *&head){
    if(entry == NULL)
        return; // árbol vacío, no hay nada que hacer

...
public:
    ...
    OrderedDictionaryEntry *getLeastElement();	//  Da el elemento menor dentro del árbol. @return 
    OrderedDictionaryEntry *getGreatestElement();	//  Da el elemento mayor dentro del árbol.  @return 
    
    void deleteInDepth();	//  Borra el elemento y los que tiene enlazados
    
    virtual ~OrderedDictionaryEntry();	//  Borra el objeto 
private:
    OrderedKey *key;
    ICollectible *val;
